...
export function ViewportCompare({
  ...
  const [zoomLevel, setZoomLevel] = useState<number>(1); // 1 = fit, 2 = 200%, 4 = 400%
  const containerRef = useRef<HTMLDivElement>(null);
  const originalCanvasRef = useRef<HTMLCanvasElement>(null);

  // Render original image on original canvas whenever originalImage changes
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-full space-y-3" id="viewport">
      {/* Top bar with View Mode & Zoom Controls */}
      ...
      >
        ...
        {/* Canvas Display Logic based on viewMode */}
        {viewMode === 'split' && (
          <div className="relative w-full h-full flex items-center justify-center overflow-auto p-4">
            ...
            >
              ...
              {/* Layer 2: Mangled Image (Top Layer clipped to slider position) */}
              <div
